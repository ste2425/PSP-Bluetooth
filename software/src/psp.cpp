...
// TODO - refactor entire file. This was coppied from consolizer
...
void PSP_setup()
{
    GPIOPinConfig cfg = gpioCfg_getConfig();
    ...
    pins[5] = cfg.DPadUp;
    pins[6] = cfg.DPadDown;
    pins[7] = cfg.DpadRight;
    pins[8] = cfg.DpadLeft;
    pins[9] = cfg.R1;
    pins[10] = cfg.Cross;
    pins[11] = cfg.circle;
    pins[12] = cfg.Square;
    pins[13] = cfg.Triangle;
}
